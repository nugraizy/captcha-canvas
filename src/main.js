...
class CaptchaGenerator {
	...
	constructor(options = {}) {
         ...
         * @private
         */
		let texty = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz1234567890"
		let textyRan = ""
		for (let i = 0; i < 6; i++) {
			textyRan += texty.charAt(Math.floor(Math.random() * texty.length))
		}
		this.captcha.text = textyRan
